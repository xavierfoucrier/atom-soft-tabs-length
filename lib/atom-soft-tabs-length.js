...
export default {
  ...
  observe() {
    ...
    // observes useEditorConfig property
    this.observer.add(atom.config.observe('atom-soft-tabs-length.useEditorConfig', {}, (value) => {
      this.setUseEditorConfig(value);
    }));
  },
